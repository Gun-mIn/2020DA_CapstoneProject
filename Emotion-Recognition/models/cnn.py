...
def origin_XCEPTION(input_shape, num_classes):
    gpus = tf.config.experimental.list_physical_devices('GPU')
    if gpus:
        try:
            for gpu in gpus:
    ...
    for i in range(8):
        ...
        x = SeparableConv2D(256, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv3')(x)
    ...
    x = SeparableConv2D(512, (3, 3), padding='same', use_bias=False, name='block13_sepconv2')(x)
